...
hour_cnt1 = 0 # hours worked are less than 5 hours
hour_cnt2 = 0 # hours worked are between 5 and 9 hours
hour_cnt3 = 0 # hours worked are between 10 and 14 hours
hour_cnt4 = 0 # hours worked are between 15 and 18 hours
hour_cnt5 = 0 # hours worked are greater than 18
...
# outputting stats
print(hour_cnt1, ":: employee/s worked less than 5 hours")
print(hour_cnt2, ":: employee/s worked between 5 and 9 hours")
print(hour_cnt3, ":: employee/s worked between 10 and 14 hours")
print(hour_cnt4, ":: employee/s worked between 15 and 18 hours")
print(hour_cnt5, ":: employee/s worked greater than 19 hours")
